...
export const DEFAULT_TS_CONFIG_TOKEN = new InjectionToken<TsConfig>(
  "ng.v5.defaultTsConfig"
);

export const DEFAULT_TS_CONFIG_PROVIDER: Provider = provideTsConfig();

export const INIT_TS_CONFIG_TOKEN = new InjectionToken<Transform>(
  "ng.v5.initTsConfigTransform"
);
